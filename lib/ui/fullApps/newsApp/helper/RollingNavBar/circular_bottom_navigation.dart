...
// import 'package:newsappui/helper/RollingNavBar/tab_item.dart';
...
class CircularBottomNavigation extends StatefulWidget {
  ...
  const CircularBottomNavigation(this.tabItems,
      {this.selectedPos = 0,
      this.barHeight = 60,
      ...
      children.add(
        Positioned(
          child: Transform.scale(
            ...
            child: widget.tabItems[pos].icon == null
                ? SvgPicture.asset(
                    "assets/images/fullApps/newsapp/svg/${widget.tabItems[pos].image}",
                    color: iconColor,
