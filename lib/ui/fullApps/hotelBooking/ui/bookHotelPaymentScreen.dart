...
class BookHotelPaymentScreen extends StatefulWidget {
  const BookHotelPaymentScreen({Key? key}) : super(key: key);

  @override
  State<BookHotelPaymentScreen> createState() => _BookHotelPaymentScreenState();
}

class _BookHotelPaymentScreenState extends State<BookHotelPaymentScreen> {
  int groupValue = 0;
            ...
            children: [
              ...
              AppButton(
                  ...
                  voidCallBack: () {
                    //open custom dialog
                    Navigator.pushNamed(
                        context, bookHotelBookingDescriptionScreen);
                  }),
            ],
          ),
        ),
